...
<h2 class="mbx">当前位置：人员管理 &nbsp;&gt;&nbsp; 人员修改</h2>  
...
<div class="cztable">
	<table border="0" cellspacing="0" cellpadding="0" width="98%">
		...
		<tr>
			...
			<td align="left"><%="1".equals(xb)?"男":"女" %></td>
		...
		<tr>
			...
			<td align="left"><input type="password" class="input_2" name="zhmm1" style="width: 60%" value="<%=zhmm %>" /></td>
		</tr>
		<tr>
			<td></td><td></td>
			<td></td><td></td>
...
<input type="hidden" name="zhbm" value="<%=zhbm %>" />
...
function save() {
	...
	form1.action = "<%=path %>/rygl/updateRyxx.do";
	form1.submit();
}

function goBack() {
	window.location.href = "<%=path %>/rygl/ryxgcx.jsp";
}
</script>
</html>
