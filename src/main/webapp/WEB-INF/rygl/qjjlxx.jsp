			...
			if (vb.getQjxx() != null && vb.getQjxx().length > 0) {
				...
				<tr align="center">
					<td colspan="4">
						<table border="0" cellspacing="0" cellpadding="0" width="98%">
							<tr align="center">
								<td width="15%"><h1>请假日期</h1></td>
								<td width="15%"><h1>请假时间起</h1></td>
								<td width="15%"><h1>请假时间止</h1></td>
								<td width="10%"><h1>请假时长</h1></td>
								<td width="10%"><h1>请假类别</h1></td>
								<td width="25%"><h1>请假原因</h1></td>
								<td width="10%"><h1>负责人</h1></td>
							</tr>
				<%
...
<script type="text/javascript">
	function goBack() {
		window.location.href = "<%=path%>/rygl/ryqjjlcx.jsp";
	}
</script>
</html>
